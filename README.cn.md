...
合计: **114,617** 行代码（覆盖前 5 种语言、共 **134** 个文件）。
...
- **上游仓库**: <https://github.com/boyter/scc>
- **许可证**: MIT
...
- **Star**: 8,740 · **Fork**: 344 · **开放 issue**: 342 · **贡献者**: 138

## 累计统计

- **发布数**: 45 · **已合并 PR**: 386 · **开放 PR**: 3 · **已关闭 issue**: 319 · **开放 issue**: 23 · **提交数**: 1677

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-14 | 2 | 22 | 0 | 4 | 1 | 25 |
| last60d | 2026-07-15 | 2 | 34 | 0 | 5 | 2 | 42 |
| 90d | 2026-06-15 | 2 | 47 | 0 | 6 | 2 | 77 |
| last180d | 2026-03-17 | 2 | 69 | 3 | 11 | 3 | 113 |
| 360d | 2025-09-18 | 4 | 103 | 3 | 17 | 4 | 163 |
| last720d | 2024-09-23 | 6 | 197 | 3 | 45 | 11 | 298 |
...
scc 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `scc` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/scc.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260913.yml` · 2026-09-13T02:29:40Z._
